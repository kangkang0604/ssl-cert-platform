...
-- 创建数据库
CREATE DATABASE IF NOT EXISTS ssl_cert DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE ssl_cert;
...
CREATE TABLE IF NOT EXISTS cert_monitor (
  ...
  KEY idx_cert_id (cert_id),
  KEY idx_domain (domain)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='监控记录4_unicode_ci表';
